...
<template>
  ...
  <vk-data-goods-sku-popup
    ...
    buy-now-background-color="#C3A769"
    ref="skuPopupRef"
    :actived-style="{
      color: '#C3A769',
      borderColor: '#eca90e;',
  ...
  <view class="toolbar" :style="{ paddingBottom: safeAreaInsets?.bottom + 'px' }">
    <view class="icons">
      <button class="icons-button"><text class="icon-icon_collect"></text>收藏</button>
      <button class="icons-button" open-type="contact"><text class="icon-kefu"></text>客服</button>
